    ...
    <section id="registration" class="border">
        <form id="login-form" action="{{ route('login') }}" method="post">
            ...
            <ul>
                ...
                <li>
                    <input class="input" name="email" id="User_email" type="text" maxlength="128"> </li>
            </ul>
            <ul>
                <li>Введите Ваш пароль *</li>
                <li><input required="required" class="input" name="password" id="User_password" type="password"
                        maxlength="128"> </li>
            </ul>
        ...
        <div class="inner">
            <div class="on-desktop" id="block-desktop">
                ...
                <div> Обязательно ознакомьтесь с информацией, написанной ниже, чтобы не потерять доступ к
                    ...
                    <span style="color:yellow">Внимание! Так же советуем добавить к себе Telegram-бота для обхода
                        блокировок: <a style="border-bottom: 1px dotted yellow;" href="http://t.me/zapretoffbot"
                ...
                <div id="sp2">
                    ...
                    <br>
                    <div> 1. Скачайте Opera для своей операционной системы <a href="http://www.opera.com/ru"
                ...
                <div> Самое простое и легкое решение - это <a href="https://epicbrowser.com/" target="_blank">Epic
                        Browser</a>, <a href="http://www.opera.com/ru">Opera</a> и <a
            ...
            <div class="btns">
                ...
                <div class="on-desktop" id="help-desktop">
                    <a href="/user/registration#" onclick="showMobile()">Показать инструкцию для
                        телефонов</a>
                </div>
                <div class="on-mobile" id="help-mobile">
                    <a href="/user/registration#" onclick="showDesktop()">Показать инструкцию для
                        компьютеров</a>
                </div>
            </div>
        </div>
...
</div><iframe style="display:none;" src="./mur48.biz_files/iframe(1).html"></iframe>
@endsection
