    ...
    <section id="registration" class="border">
        <form id="login-form" action="{{ route('register') }}" method="post">
            ...
            <ul>
                ...
                <li>
                    <input required="required" class="input" name="name" id="User_username" type="text"
                        maxlength="20"> </li>
            </ul>
            ...
            <ul>
                ...
                <li><input required="required" class="input" name="password_confirmation" id="User_password2" type="password">
                </li>
            </ul>
            <ul>
