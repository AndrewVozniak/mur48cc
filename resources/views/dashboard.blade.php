...
<div class="content">
    ...
    <section id="universal" class="border">
        <link rel="stylesheet" type="text/css" href="./mur48.biz_files/cabinet.css">

        <div id="all_cabinet">
            <div><a href="https://mur48.biz/user/myorders" class="block">Ваши покупки</a></div>

            <br>
            <div><a href="https://mur48.biz/user/mytickets" class="block">Ваши тикеты и перезаклады </a></div>

            <br>
            <div><a href="https://mur48.biz/user/myPaidTransactions" class="block">Заявки на покупки и пополнения</a>
            </div>
            <br>
            <div><a href="https://mur48.biz/user/myExchangerTickets" class="block">Завис платёж? </a></div>

            <br>
            <div><a href="https://mur48.biz/user/createIssue" class="block">Не нашли клад?</a></div>
...
<section id="warning_apk" style="display: none">
    <div class="text">
        <div class="inner">
            ...
            <a href="https://mur48.biz/app.apk" target="_blank"><img src="./mur48.biz_files/nGyAD4L.png"
                    class="download"></a>
            <br>
            <div class="btns">
        ...
        <div class="inner">
            ...
            <div class="btns">
                ...
                <div class="on-desktop" id="help-desktop">
                    <a href="https://mur48.biz/user/cabinet#" onclick="showMobile()">Показать инструкцию для
                        телефонов</a>
                </div>
                <div class="on-mobile" id="help-mobile">
                    <a href="https://mur48.biz/user/cabinet#" onclick="showDesktop()">Показать инструкцию для
                        компьютеров</a>
                </div>
            </div>
        </div>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="padding: 0 3px 0 3px;"
                                                                                    ...
                                                                                    <a href="https://mur48.biz/user/cabinet#"
        ...
        <tbody>
            <tr id="IKLAD_OPINION_HEADER_5357">
                ...
                <td width="10" style="padding: 0 1px 0 5px !important;" align="center"><a style="text-decoration: none;"
                        href="https://mur48.biz/user/cabinet#"
