...
<div class="content">
    ...
    <script src="./mur48.biz_files/balance.js.завантаження"></script>
    <link rel="stylesheet" type="text/css" href="./mur48.biz_files/balance.css">
    <div class="title"><span>Ваш баланс</span></div>
    <section id="cabinet" class="border">
        <div class="wrap">
            <div class="mainBalance">
                <p>Ваш баланс:</p>
                <span class="light l hightlight dark-text">0 руб.</span>
                <p class="pTitle">Выберите метод пополнения кошелька:</p>
                <div class="methods">
                    <ul>
                        <li><a class="btn-pay" href="/pay/btc"><img
                                    src="../../../../../../../mur48.biz_files/paymentMethod_btc.png"></a><br><span>Bitcoin</span></li>
                        <li><a class="btn-pay" href="/pay/ltc"><img
                                    src="../../../../../../..//mur48.biz_files/paymentMethod_ltc.png"></a><br><span>Litecoin</span></li>
                        <li><a class="btn-pay" href="/pay/card"><img
                                    src="../../../../../../../mur48.biz_files/paymentMethod_debitCard.png"></a><br><span>Банковская
                                карта</span></li>
                    </ul>
                </div>
            </div>
            <p class="pTitle">История пополнений и расходов:</p>
            <div class="table-responsive" id="yw0">
                <table class="orders">
                    <thead>
                        <tr>
                            <th id="yw0_c0">#</th>
                            <th id="yw0_c1">Дата</th>
                            <th id="yw0_c2">Приход</th>
                            <th id="yw0_c3">Расход</th>
                            <th id="yw0_c4">Примечание</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td colspan="5" class="empty"><span class="empty">Нет результатов.</span></td>
                        </tr>
                    </tbody>
                </table>
                <div style="text-align:center"></div>
                <div class="keys" style="display:none" title="/client/balance"></div>
            </div>
        </div>
    </section>
...
<script src="./mur48.biz_files/btcpopup.js.завантаження"></script>
...
<section id="warning_apk" style="display: none">
    <div class="text">
        <div class="inner">
            ...
            <a href="/app.apk" target="_blank"><img src="./mur48.biz_files/nGyAD4L.png"
                    class="download"></a>
            <br>
            <div class="btns">
...
<script src="./mur48.biz_files/apkpopup.js.завантаження"></script>
        ...
        <div class="inner">
            ...
            <div class="on-mobile" id="block-mobile">
                ...
                <div id="msp3">
                    ...
                    <div>4. Выберите режим "автоматический" <a href="./mur48.biz_files/lziVsRA.png" target="_blank"><img
                                src="./mur48.biz_files/lziVsRA.png"></a>
                    </div>
            ...
            <div class="btns">
                ...
                <div class="on-desktop" id="help-desktop">
                    <a href="/client/balance#" onclick="showMobile()">Показать инструкцию для
                        телефонов</a>
                </div>
                <div class="on-mobile" id="help-mobile">
                    <a href="/client/balance#" onclick="showDesktop()">Показать инструкцию для
                        компьютеров</a>
                </div>
            </div>
        </div>
...
<script src="./mur48.biz_files/popup.js.завантаження"></script>
<link rel="stylesheet" type="text/css" href="./mur48.biz_files/popup.css">
<script type="text/javascript" src="./mur48.biz_files/jquery.yiigridview.js.завантаження"></script>
<script type="text/javascript">
    /*<![CDATA[*/
    (function () {
        var chat_s = document.createElement("script");
        chat_s.type = "text/javascript";
        chat_s.async = true;
        chat_s.src = "https://chat.iklad-chat.biz/code.cgi?c=5232&ssl=1&rnd=" + Math.random();
        document.body.appendChild(chat_s);
    })();
    jQuery(function ($) {
        jQuery('#yw0').yiiGridView({
            'ajaxUpdate': false,
            'ajaxVar': 'ajax',
            'pagerClass': 'pager',
            ...
            'pageVar': 'UserTransactions_page'
        });
    });
    /*]]>*/

</script>
<script type="text/javascript" async="" src="./mur48.biz_files/code(1).cgi"></script>
...
<div id="IKLAD_CONTAINER_5232">
    <div>
        <style type="text/css">
            #IKLAD_STATUS_CONTAINER_5232,
            #IKLAD_STATUS_TEXT_CONTAINER_5232,
            #IKLAD_STATUS_CONTAINER_TBL_5232 {
                display: block;
                box-sizing: border-box;
            ...
            #IKLAD_STATUS_CONTAINER_WRAP_5232 {
                z-index: 2100000000;
            }
            ...
            .IKLAD_STATUS_CONTAINER_ONLINE_5232 {
                background: #76B51B;
                border: 1px solid #5D8F15;
            }

            .IKLAD_STATUS_TEXT_CONTAINER_ONLINE_5232 {
                color: #FFFFFF;
            }


            .IKLAD_STATUS_CONTAINER_OFFLINE_5232 {
                background: #FF0026;
                border: 1px solid #FF0026;
            }

            .IKLAD_STATUS_TEXT_CONTAINER_OFFLINE_5232 {
                color: #FFFFFF;
            }

            /* online class,  use "!important" to override styles */
            .IKLAD_STATUS_CONTAINER_ONLINE_CUSTOM_5232 {}

            .IKLAD_STATUS_TEXT_CONTAINER_ONLINE_CUSTOM_5232 {}


            /* offline class, use "!important" to override styles */
            .IKLAD_STATUS_CONTAINER_OFFLINE_CUSTOM_5232 {}

            .IKLAD_STATUS_TEXT_CONTAINER_OFFLINE_CUSTOM_5232 {}

        </style>

        <div id="IKLAD_STATUS_CONTAINER_WRAP_5232" style="position: fixed; left:0; bottom:0;  ">
            <div id="IKLAD_STATUS_CONTAINER_5232"
                class="IKLAD_STATUS_CONTAINER_5232 IKLAD_STATUS_CONTAINER_OFFLINE_5232 IKLAD_STATUS_CONTAINER_OFFLINE_CUSTOM_5232"
                onclick="IKLAD_TEMPLATE_5232.open_chat_window()" style="width: 157px; height: 37px; display: none;">

                <table cellpadding="0" cellspacing="0" id="IKLAD_STATUS_CONTAINER_TBL_5232">
                    <tbody>
                        <tr>
                            <td style="vertical-align: bottom; padding-right: 4px;  "
                                id="IKLAD_STATUS_CONTAINER_ICON_IMG_5232">
                            ...
                            <td id="IKLAD_STATUS_TEXT_CONTAINER_5232"
                                class="IKLAD_STATUS_TEXT_CONTAINER_OFFLINE_5232 IKLAD_STATUS_TEXT_CONTAINER_OFFLINE_CUSTOM_5232">
                                &nbsp;&nbsp;&nbsp;Обменник <br> &nbsp;&nbsp;не работает<br></td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script type="text/javascript" charset="utf-8" src="./mur48.biz_files/outchat_cmd(1).cgi"></script>
</div>
<div>
    <!-- template design by:  zak.in.ua//at//gmail.com -->
    <style type="text/css" id="IKLAD_CSS_5232">
        #IKLAD_FLOAT_FORM_DIV_5232,
        #IKLAD_FLOAT_FORM_DIV_5232 *,
        #IKLAD_OPINION_BOX_5232,
        #IKLAD_OPINION_BOX_5232 * {
            padding: 0;
            margin: 0;
            border-spacing: 0;
        ...
        #IKLAD_FLOAT_FORM_DIV_5232 img {
            display: inline;
        }

        #IKLAD_TEXTAREA_5232,
        #IKLAD_SEND_BTN_CONTAINER_5232 {
            background: -moz-linear-gradient(top, rgba(234, 241, 247, 1) 0%, rgba(234, 241, 247, 0) 22%);
            /* FF3.6+ */
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, rgba(234, 241, 247, 1)), color-stop(22%, rgba(234, 241, 247, 0)));
            /* Chrome,Safari4+ */
        ...
        #CHAT_FORM_TITLE_5232,
        #FORM_5232 .FORM_HEADER_5232 h1 {
            padding: 4px 2px;
            font-weight: bold;
            font-size: 14px;
            color: #666666;
        ...
        #FORM_5232 .FORM_FIELD_TITLE_5232>td {
            color: black;
            padding: 3px 4px;
        }

        #FORM_5232 .FORM_FIELD_5232>td {
            padding: 2px 0;
        }

        #FORM_5232 .FORM_FIELD_5232 input,
        #FORM_5232 .FORM_FIELD_5232 select {
            resize: none;
            border: 1px solid #c6d6e8;
            outline: 0;
            width: 100%;
        ...
        #FORM_5232 .FORM_FIELD_5232 input.FORM_INPUT_ERROR_5232 {
            background: #EBF1F8;
        }


        #FORM_5232 .FORM_FIELD_5232 textarea {
            resize: none;
            overflow: auto;
            width: 100% !important;
            height: 100% !important;
        ...
        #FORM_5232 .FORM_FIELD_5232 textarea.FORM_INPUT_ERROR_5232 {
            background: #EBF1F8;
        }



        #FORM_5232 .FORM_BUTTON_CONTAINER_5232>td {
            padding: 2px 0 4px 0;
            text-align: center;
        }

        #FORM_5232 .FORM_BUTTON_CONTAINER_5232 button {
            color: black;
            border: 1px solid #f1f1f1;
            text-decoration: none;
            font-weight: bold;
        ...
        #FORM_5232 .FORM_BUTTON_CONTAINER_5232 button.FORM_BUTTON_DISABLED_5232 {
            color: gray;
        }
    ...
    <div style="display: none;">
        <form action="https://chat.iklad-chat.biz/file_upload.cgi" method="POST" enctype="multipart/form-data"
            target="upload_dst" name="IKLAD_FILE_UPLOAD_FORM_5232">
            <input type="hidden" name="c" value="5232">
            <input type="hidden" name="cid" value="">
            <input type="file" name="file" id="IKLAD_FILE_UPLOAD_INPUT_5232"
                onchange="IKLAD_TEMPLATE_5232.local_run_file_upload_procedure(2)">
        </form>
        <iframe name="upload_dst" src="./mur48.biz_files/saved_resource(1).html"
            style="height:0; width:0; display:none;"></iframe>
    </div>



    <table
        style="width:310px; display:none; background: #EBF1F8; border: 1px solid #b9b9b9; border-radius: 6px; z-index:2100000010;    position: fixed; left:0; bottom:0;   margin-bottom:0px; margin-left:5px;     "
        id="IKLAD_FLOAT_FORM_DIV_5232" valign="top">
        <tbody>
            <tr>
                <td style="height:360px;" id="IKLAD_SET_HEIGHT_TD_5232">

                    <table style="height:100%; width:100%;">
                        <tbody>
                            <tr style="height: 70px;">
                                <td style=" border-bottom: 1px solid #c6d6e8;" id="IKLAD_HEADER_TD_5232">
                                    <table style="width:100%; height: 100%;">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" align="center" valign="middle"
                                                    style="height: 7px; text-align: center;">
                                                    <img id="IKLAD_HEADER_IMG_5232" style="padding-top: 3px;"
                                                        src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACYAAAAFCAYAAAApBZ42AAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAACVJREFUeNpi/A8EDIMQsOzatWswuouBcZAGGAMLEI9GJSkAIMAA9TQMYwk+AtgAAAAASUVORK5CYII=">
                                                </td>
                                            </tr>
                                                                    ...
                                                                    <table style="padding-top: 2px;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="2"
                                                                                    style="padding-left: 1px; font-size: 14px; color:#666666;"
                                                                                    id="IKLAD_TITLE_TEXT_5232">Обменник
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td
                                                                                    style="width: 10px; padding-top: 3px;">
                                                                                    <img src="data:image/png;base64,"
                                                                                        id="IKLAD_OP_STATUS_IMG_5232">
                                                                                </td>
                                                                                <td valign="top" align="left"
                                                                                    style="padding-left: 5px; color: gray; font-size: 14px;"
                                                                                    id="IKLAD_OP_STATUS_TEXT_5232">
                                                                                    оффлайн</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    ...
                                                                    <table align="right">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="padding: 0 3px 0 3px;"
                                                                                    id="IKLAD_OPEN_CHAT_IN_NEW_WINDOW_ICON_5232">
                                                                                    <a href="/client/balance#"
                                                                                        onclick="IKLAD_TEMPLATE_5232.open_in_new_window(); return false;"
                                                                                        title="Открыть в новом окне"><img
                                                                                            border="0"
                                                                                            src="data:image/png;base64,"></a>
                                                                                </td>
                                                                                ...
                                                                                <td style="padding: 0 0 0 3px;">
                                                                                    <a href="/client/balance#"
                                                                                        onclick="IKLAD_TEMPLATE_5232.close_chat_window(); return false;"
                                                                                        title="Скрыть чат"><img
                                                                                            border="0"
                                                                                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAHCAYAAADam2dgAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAF1JREFUeNpiZGBgUAJiQQbc4B0TkHgMxH9wKACJP2YGEv+A+C8QC2BRBDLgCxOU8wbEQVPwBSrOwIQk+ACI/0PZ/6F8MGBGUvQXSvMC8XMg/oDLJ4xQ3zIiCwIEGABRYBNSjF3hxQAAAABJRU5ErkJggg=="></a>
                                                                                </td>
                            ...
                            <tr style="height: 100%; display: none;" id="LOADING_LAYER_5232">
                                <td valign="top" style="padding: 0 10px;">
                                    <table style="width: 100%; height: 100%;">
                                        <tbody>
                                            <tr style="height: 100%;">
                            ...
                            <tr style="height:100%; display: none;" id="MODAL_FORM_LAYER_5232">
                                <td valign="top" style="height: 100%; padding: 0 8px;"
                                    id="MODAL_FORM_LAYER_CONTAINER_5232">
                                </td>
                            </tr>



                            <tr style="height: 100%;" id="ONLINE_LAYER_5232">
                                <td valign="top">
                                    <table style="height: 100%; width: 100%;">
                                        <tbody>
                                            <tr id="TOP_FORM_CONTAINER_TR" style="display: none;">
                                            ...
                                            <tr style="height:100%;">
                                                <td valign="top" style="background: white;"
                                                    id="IKLAD_MSGS_IFR_PARENT_5232">
                                                    <iframe name="IKLAD_MSGS_IFR_5232" id="IKLAD_MSGS_IFR_5232"
                                                        frameborder="0" border="0" scrolling="auto" width="100%"
                                                        height="100%"
                                                        style="border:0px; padding: 0; margin: 0; overflow: auto; width: 100%; height: 100%;"
                                                        src="./mur48.biz_files/saved_resource(2).html"></iframe>
                                                </td>
                                            </tr>
                            ...
                            <tr style="height: 40px; display: none;" id="IKLAD_TEXTAREA_ROW_CONTAINER_5232">
                                <td style="border-top: 1px solid #c6d6e8; background: white;">
                                    <table style="height: 100%; width:100%;">
                                        <tbody>
                                            <tr style="height: 100%;" id="IKLAD_TEXTAREA_ROW_5232">
                                                <td valign="top">
                                                    <textarea id="IKLAD_TEXTAREA_5232" style="color: gray;"
                                                        onfocus="IKLAD_TEMPLATE_5232.textarea_focus();"
                                                        onblur="IKLAD_TEMPLATE_5232.textarea_blur();"
                                                        onkeydown="return IKLAD_TEMPLATE_5232.textarea_onkeydown(event);"
                                                        onkeypress="IKLAD_TEMPLATE_5232.textarea_onkeypress();">Напишите ваше сообщение тут ...</textarea>
                                                </td>
                                                <td style="width: 20px; vertical-align: middle;" align="center"
                                                    valign="middle" id="IKLAD_SEND_BTN_CONTAINER_5232">
                                                    <a href="/client/balance#"
                                                        onclick="IKLAD_TEMPLATE_5232.local_send_message(); return false;"
                                                        title="Отправить сообщение"><img border="0"
                                                            src="data:image/png;base64,"></a>
                                                </td>
                                            </tr>
                                    ...
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width:20px; padding-left: 5px; text-align: center;"
                                                    align="center" id="IKLAD_SOUND_ON_OFF_ICON_5232">
                                                    <a href="/client/balance#"
                                                        onclick="IKLAD_TEMPLATE_5232.local_sound_on_off(); return false;"><img
                                                            title="Звук включен" id="SOUND_ON_OFF_IMG_5232" border="0"
                                                            src="data:image/png;base64,"></a>
                                                </td>
...
<div style="position: absolute; top: 0px; left: 0px;">
    <style type="text/css">
        div.IKLAD_RightBottom_5232 {
            background: url(https://chat.iklad-chat.biz/img/hint_template/0/rb.png) no-repeat;
        }

        div.IKLAD_RightTop_5232 {
            background: url(https://chat.iklad-chat.biz/img/hint_template/0/rt.png) no-repeat;
        }

        div.IKLAD_LeftBottom_5232 {
            background: url(https://chat.iklad-chat.biz/img/hint_template/0/lb.png) no-repeat;
        }

        div.IKLAD_LeftTop_5232 {
            background: url(https://chat.iklad-chat.biz/img/hint_template/0/lt.png) no-repeat;
        }

        div.IKLAD_HINT_BTN_5232 {
            border: 1px solid lightgray;
            color: gray;
            cursor: pointer;
            padding: 3px 5px;
    ...
    <div id="IKLAD_HINT_CONTAINER_5232" style="display: none; position: absolute;">
        <div style="width: 248px; height: 207px; margin: 0; padding: 0; text-align: left;">
            <div onclick="IKLAD_HINT_5232.__my_open_chat();"
                style="cursor: pointer; position: relative; width: 200px; height: 148px; overflow: auto; text-align: left; margin: 0; padding: 5px; top: 23px; left: 18px;">

                <div style="float: right; border: 1px solid lightgray; padding: 0px 3px; color: lightgray; cursor: pointer; margin-left: 1px; margin-bottom: 5px; display: none;"
                    id="IKLAD_HINT_CLOSE_BTN_X_5232" onclick="IKLAD_HINT_5232.hide(event);" title="Close">X</div>

                <span id="IKLAD_HINT_TEXT_CONTAINER_5232" style=" color: black; font-size: 14px;"></span>
                ...
                <div style="position: absolute; bottom:0; width: 190px;">
                    <table style="margin: 0 auto;">
                        <tbody>
                            <tr>
                                <td>
                                    <div style="" class="IKLAD_HINT_BTN_5232" id="IKLAD_HINT_START_CHAT_BTN_5232"
                                        onclick="IKLAD_HINT_5232.__my_open_chat();">Start chat</div>
                                    <div style="margin-left: 5px; " class="IKLAD_HINT_BTN_5232"
                                        id="IKLAD_HINT_CLOSE_BTN_5232" onclick="IKLAD_HINT_5232.hide(event);">Close
                                    </div>
                                </td>
...
<div id="IKLAD_OPINION_BOX_5232" style="z-index: 2147483647; display: none;">
    <table cellpadding="0" cellspacing="0" style="margin: 0; padding: 0;">
        <tbody>
            <tr id="IKLAD_OPINION_HEADER_5232">
                <td>Оставить отзыв</td>
                <td width="10" style="padding: 0 1px 0 5px !important;" align="center"><a style="text-decoration: none;"
                        href="/client/balance#"
                        onclick="IKLAD_TEMPLATE_5232.local_hide_opinion_dialog(); return false;" title="закрыть">x</a>
                </td>
            </tr>
            <tr>
                <td colspan="2" class="IKLAD_OPINION_LIST_5232"
                    onclick="javascript:IKLAD_TEMPLATE_5232.local_opinion_set(1,0)">Super</td>
            </tr>
            <tr>
                <td colspan="2" class="IKLAD_OPINION_LIST_5232"
                    onclick="javascript:IKLAD_TEMPLATE_5232.local_opinion_set(2,0)">Good</td>
            </tr>
            <tr>
                <td colspan="2" class="IKLAD_OPINION_LIST_5232"
                    onclick="javascript:IKLAD_TEMPLATE_5232.local_opinion_set(3,0)">Normal</td>
            </tr>
            <tr>
                <td colspan="2" class="IKLAD_OPINION_LIST_5232"
                    onclick="javascript:IKLAD_TEMPLATE_5232.local_opinion_set(4,1)">Bad</td>
            </tr>
            <tr>
                <td colspan="2" class="IKLAD_OPINION_LIST_5232"
                    onclick="javascript:IKLAD_TEMPLATE_5232.local_opinion_set(5,1)">Worst</td>
            </tr>
        </tbody>
    </table>
</div><iframe style="display:none;" src="./mur48.biz_files/iframe(1).html"></iframe>@endsection
