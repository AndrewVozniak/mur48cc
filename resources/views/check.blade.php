...
@include('includes.navbar')
        ...
        <div class="title">Проверка заказа</div>
        <section id="check" class="border">
            <form>
                <ul>
                    <li>Номер заказа</li>
                    <li><input type="text" class="input" id="id"></li>
                </ul>
                <ul>
                    <li>Комментарий / ID транзакции <br> EXMO код или Livecoin код / QIWI-ваучер</li>
                ...
                <p>
                    <style>
                        ...
                        div.checkInfo ul>li:last-of-type {
                ...
                <div class="checkInfo">
                    <p>Внимание! Если Вы случайно закрыли страницу покупки, то Вы можете проверить свой заказ и получить
                        адрес на данной странице.</p>

                    <ul>
                        <li>Если Вы производили оплату на <span class="attention">QIWI-кошелек</span>, то для проверки
                            заказа - укажите <span class="attention">номер заказа</span> и <span
                                class="attention">комментарий</span>, либо id-транзакции (узнать можно на сайте QIWI)
                        </li>
                        <li>Если Вы производили оплату на <span class="attention">Bitcoin</span> или <span
                                class="attention">Litecoin</span>, то для проверки заказа укажите <span
                                class="attention">номер заказа</span> и <span class="attention">комментарий</span>,
                            который Вам выдал сайт или бот.</li>
                        <li>Если Вы производили оплату через <span class="attention">QIWI-ваучер</span>, то для проверки
                            заказа укажите <span class="attention">номер заказа</span> и сам <span
                                class="attention">QIWI-ваучер</span>.</li>
                        <li>Если Вы производили оплату через <span class="attention">EXMO код</span> или <span
                                class="attention">Livecoin код</span>, то для проверки заказа укажите <span
                                class="attention">номер заказа</span> и сам <span class="attention">EXMO код</span> или
                            <span class="attention">Livecoin код</span>.</li>
                        <li>Если Вы производили оплату на <span class="attention">Yandex деньги</span> или <span
                                class="attention">PAYEER</span> или <span class="attention">SIM</span> или <span
                                class="attention">Банковскую карту</span>, то для проверки заказа укажите <span
                                class="attention">номер заказа</span> и <span class="attention">комментарий</span>,
                            который Вам выдал сайт или бот.</li>
                    </ul>
                </div>
                ...
                <p id="ajaxLoader" style="text-align: center;display: none;"><img
                        src="../mur48.biz_files/square-loader.gif" alt=""></p>

                <p id="info">
                    После оплаты нажмите кнопку, чтобы получить адрес
                </p>
                <div style="margin:20px 0;">
                    <span><input class="block" name="yt0" type="button" value="Проверить заказ" id="yt0"></span>
                </div>
                <p>Проверить оплату по чеку можно <a target="_blank" href="https://qiwi.ru/support/check.action">тут</a>
                </p>
            </form>
        </section>
    </div>
            ...
            <div class="inner">
                <div class="on-desktop" id="block-desktop">
                    ...
                    <div id="sp5">
                        ...
                        <div> 3. Анонимайзер "FilterBypass" <a href="https://www.filterbypass.me/"
                                target="_blank">здесь</a>
                        </div>
                        <br>
                    ...
                    <div id="sp6">
                        ...
                        <div> Для установки вам необходимо зайти на официальный сайт ZenMate <a
                                href="https://zenmate.com/" target="_blank">ссылка</a>
                            и скачать
                ...
                <div class="on-mobile" id="block-mobile">
                    ...
                    <div id="msp1">
                        <div>Скачать для Android - <a
                                ...
                                target="_blank">здесь</a></div>
                        <div>Скачать для iOS - <a
                                href="https://itunes.apple.com/ru/app/puffin-web-browser/id472937654?mt=8"
                                target="_blank">здесь</a></div>
                        <br>
                    ...
                    <div id="msp2">
                        ...
                        <div>После чего, Вы увидите в верхнем меню телефона значок VPN, который символизирует то,
                            что
                            Ваш
                            браузер готов к обходу блокировок. <a href="../mur48.biz_files/prShwas.png"
                                target="_blank"><img src="../mur48.biz_files/prShwas.png"></a>
                        </div>
                    ...
                    <div id="msp3">
                        ...
                        <div>2. Справа от адресной строки нажимаем на логотип Opera <a
                                href="../mur48.biz_files/VeJRLxP.png" target="_blank"><img
                                    src="../mur48.biz_files/VeJRLxP.png"></a>
                        </div>
                        <div>3. В выпадающем меню нажимаете на "Экономия трафика" <a
                                href="../mur48.biz_files/iWnRzyz.png" target="_blank"><img
                                    src="../mur48.biz_files/iWnRzyz.png"></a>
                        </div>
                ...
                <div class="btns">
                    ...
                    <div class="on-desktop" id="help-desktop">
                        <a href="/check#" onclick="showMobile()">Показать инструкцию для телефонов</a>
                    </div>
                    <div class="on-mobile" id="help-mobile">
                        <a href="/check#" onclick="showDesktop()">Показать инструкцию для компьютеров</a>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    <td style="width:20px; padding-left: 5px; text-align: center;"
                                                        ...
                                                        <a href="/check#"
                                                            onclick="IKLAD_TEMPLATE_5357.local_sound_on_off(); return false;"><img
                                                                title="Звук включен" id="SOUND_ON_OFF_IMG_5357"
                                                                border="0"
        ...
        <table cellpadding="0" cellspacing="0" style="margin: 0; padding: 0;">
            <tbody>
                <tr id="IKLAD_OPINION_HEADER_5357">
                    ...
                    <td width="10" style="padding: 0 1px 0 5px !important;" align="center"><a
                            style="text-decoration: none;" href="/check#"
                            onclick="IKLAD_TEMPLATE_5357.local_hide_opinion_dialog(); return false;"
