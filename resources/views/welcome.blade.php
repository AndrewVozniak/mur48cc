...
<div class="content">
    ...
    <section id="index">
        ...
        <ul id="cities" class="l_tinynav1">
            <li class="selected"><a href="/?city_id=1">Москва</a></li>
            <li class=""><a href="/?city_id=3">Санкт-Петербург</a></li>
            <li class=""><a href="/?city_id=6">Воронеж</a></li>
            <li class=""><a href="/?city_id=7">Тосно</a></li>
            <li class=""><a href="/?city_id=10">Люберцы</a></li>
            <li class=""><a href="/?city_id=12">Балашиха</a></li>
            <li class=""><a href="/?city_id=14">Химки </a></li>
            <li class=""><a href="/?city_id=15">Одинцово </a></li>
            <li class=""><a href="/?city_id=16">Подольск</a></li>
            <li class=""><a href="/?city_id=17">Лиски</a></li>
            <li class=""><a href="/?city_id=18">Павловск</a></li>
            <li class=""><a href="/?city_id=20">Верхняя Хава </a></li>
            <li class=""><a href="/?city_id=21">Богучар</a></li>
            <li class=""><a href="/?city_id=22">Нововоронеж</a></li>
            <li class=""><a href="/?city_id=23">Таловая</a></li>
            <li class=""><a href="/?city_id=24">Балашов </a></li>
            <li class=""><a href="/?city_id=25">Бобров</a></li>
            <li class=""><a href="/?city_id=26">Борисоглебск</a></li>
            <li class=""><a href="/?city_id=27">Острогожск</a></li>
            <li class=""><a href="/?city_id=29">Королёв</a></li>
            <li class=""><a href="/?city_id=30">Мытищи </a></li>
            <li class=""><a href="/?city_id=35">Красногорск </a></li>
            <li class=""><a href="/?city_id=36">Домодедово</a></li>
            <li class=""><a href="/?city_id=37">Щелково </a></li>
            <li class=""><a href="/?city_id=38">Зеленоград </a></li>
        </ul><select id="tinynav1" class="tinynav tinynav1">
            <option>Выберите город</option>
            <option value="/?city_id=1">Москва</option>
            <option value="/?city_id=3">Санкт-Петербург</option>
            <option value="/?city_id=6">Воронеж</option>
            <option value="/?city_id=7">Тосно</option>
            <option value="/?city_id=10">Люберцы</option>
            <option value="/?city_id=12">Балашиха</option>
            <option value="/?city_id=14">Химки </option>
            <option value="/?city_id=15">Одинцово </option>
            <option value="/?city_id=16">Подольск</option>
            <option value="/?city_id=17">Лиски</option>
            <option value="/?city_id=18">Павловск</option>
            <option value="/?city_id=20">Верхняя Хава </option>
            <option value="/?city_id=21">Богучар</option>
            <option value="/?city_id=22">Нововоронеж</option>
            <option value="/?city_id=23">Таловая</option>
            <option value="/?city_id=24">Балашов </option>
            <option value="/?city_id=25">Бобров</option>
            <option value="/?city_id=26">Борисоглебск</option>
            <option value="/?city_id=27">Острогожск</option>
            <option value="/?city_id=29">Королёв</option>
            <option value="/?city_id=30">Мытищи </option>
            <option value="/?city_id=35">Красногорск </option>
            <option value="/?city_id=36">Домодедово</option>
            <option value="/?city_id=37">Щелково </option>
            <option value="/?city_id=38">Зеленоград </option>
        </select>
        <ul id="products">
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа-ПВП Кристалл Белый 0,5 гр "магнит" </div>
                    <div class="price">2949 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 4 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/210">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа-ПВП Кристалл Белый 0,5 гр "тайник" </div>
                    <div class="price">2949 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 20 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/211">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа-ПВП Кристалл Белый1 гр "магнит"</div>
                    <div class="price">3549 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 18 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/201">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа-ПВП Кристалл Белый 1 гр "тайник"</div>
                    <div class="price">3549 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 35 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/202">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон кристаллический VHQ 1г "магнит" </div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 13 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/289">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон кристаллический VHQ 1г "тайник" </div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 38 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/290">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Меф Кристаллический VHQ 1,5 гр</div>
                    <div class="price">4400 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 2 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/651">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон кристаллический VHQ 2г "тайник" </div>
                    <div class="price">5399 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 37 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/291">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон кристаллический VHQ 2г "магнит"</div>
                    <div class="price">5399 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 22 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/292">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">МЕФ Snow VHQ 1г тайник </div>
                    <div class="price">3349 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 4 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/274">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Меф KARAT V.H.Q 1 гр "магнит"</div>
                    <div class="price">3349 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 2 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/195">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Меф KARAT V.H.Q 1 гр "тайник"</div>
                    <div class="price">3349 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 20 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/196">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Меф KARAT V.H.Q 2 гр "магнит"</div>
                    <div class="price">5299 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 2 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/276">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Меф KARAT V.H.Q 2 гр "тайник"</div>
                    <div class="price">5299 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 7 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/277">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон EMPORIO VHQ 1г "магнит"</div>
                    <div class="price">3349 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 8 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/197">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон EMPORIO VHQ 1г "тайникк"</div>
                    <div class="price">3349 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 11 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/198">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон EMPORIO VHQ 2г "магнит" </div>
                    <div class="price">5299 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 1 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/286">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Мефедрон EMPORIO VHQ 2г "тайникк" </div>
                    <div class="price">5299 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 7 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/285">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Работа курьером по залогу </div>
                    <div class="price">3000 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 2 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/254">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Кристалл Синий 1 гр</div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 8 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/389">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП Кристалл Янтарный 1г</div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 18 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/426">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП Кристалл Янтарный 0.5г</div>
                    <div class="price">2849 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 4 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/427">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП 2.0 Кристалл Красный 1 гр</div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 1 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/509">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП 2.0 Кристалл Синий 1 гр </div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 1 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/518">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП 2.0 Кристалл Красный 0,5 гр</div>
                    <div class="price">2849 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 1 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/519">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП 2,0 кристалл белый 0.5 гр </div>
                    <div class="price">2849 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 6 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/522">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name">Альфа ПВП 2,0 кристалл белый 1 гр </div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 15 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/523">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name"> 1г Альфа ПВП VHQ ICE + </div>
                    <div class="price">3449 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 23 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/631">Купить</a>
                    </div>
                </div>
            </li>
            <li>
                <div class="inner">
                    <img src="./mur48.biz_files/plogo.png">
                    <div class="name"> 0,5г Альфа ПВП VHQ ICE +</div>
                    <div class="price">2849 руб.</div>
                    <div class="size">В наличии: <span class="bold"> 6 шт </span>
                    </div>
                    <div class="buy"><a class="block" href="/buy/632">Купить</a>
                    </div>
                </div>
            </li>
        </ul>
        ...
        <tbody>
            <tr id="IKLAD_OPINION_HEADER_5357">
                ...
                <td width="10" style="padding: 0 1px 0 5px !important;" align="center"><a style="text-decoration: none;"
                        href="/#" onclick="IKLAD_TEMPLATE_5357.local_hide_opinion_dialog(); return false;"
...
</div><iframe style="display:none;" src="./mur48.biz_files/iframe.html"></iframe></body>
